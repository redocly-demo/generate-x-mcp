      ...
      function pctDecChars(str2) {
        ...
        while (i < il) {
          ...
          if (c < 128) {
            ...
            if (il - i >= 9) {
              var _c2 = parseInt(str2.substr(i + 4, 2), 16);
...
var require_ajv = __commonJS({
  "node_modules/ajv/lib/ajv.js"(exports, module) {
    ...
    function _addSchema(schema2, skipValidation, meta, shouldAddSchema) {
      ...
      var id = resolve5.normalizeId(this._getId(schema2));
      if (id && shouldAddSchema) checkUnique(this, id);
      var willValidate = this._opts.validateSchema !== false && !skipValidation;
      var recursiveMeta;
      if (willValidate && !(recursiveMeta = id && id == resolve5.normalizeId(schema2.$schema)))
        this.validateSchema(schema2, true);
      var localRefs = resolve5.ids.call(this, schema2);
    ...
    function addFormat(name, format3) {
      if (typeof format3 == "string") format3 = new RegExp(format3);
    ...
    function addInitialFormats(self) {
      for (var name in self._opts.formats) {
        var format3 = self._opts.formats[name];
        self.addFormat(name, format3);
      }
    }
      ...
      Object.keys(argv3).forEach(function(key) {
        if (!applied.has(key)) {
          ...
          if (typeof coerce2 === "function") {
            try {
              const value = maybeCoerceNumber(key, coerce2(argv3[key]));
...
// src/index.ts
var argv = yargs_default(hideBin(process.argv)).option("openapi-file", {
  alias: "f",
  type: "string",
...
async function main() {
  ...
  try {
    ...
    if (openapiFileExists) {
      ...
      openapi = js_yaml_default.load(fileContents);
    } else {
      openapi = {
        openapi: "3.1.0",
        info: {
    ...
    const serverUrlExists = openapi.servers.some((server) => server.url === argv.serverUrl);
    if (!serverUrlExists) {
